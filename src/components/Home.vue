    ...
    <main>
      <section class="main_banner">
        ...
        <video autoplay muted loop>
          <source
            src="../assets/images/mainBanner_AdobeExpress.mp4 "
            type="video/mp4"
          />
        </video>
        <div class="banner_circle first show-up"></div>
        <div class="banner_logo slide-top">
      ...
      <section class="about_us">
        ...
        <div class="about_us_intro">
          <div class="title_area">
            ...
            <p>
              經過無數客人的指教與建議與多年的經驗，我們按摩師都有他獨特的手技，讓客人達到放鬆的效果。
      ...
      <section class="massage_school">
        ...
        <div class="massage_school_content">
          <div class="massage_school_intro">
            <h3>&nbsp;玩遊戲認識穴道</h3>
            <p>
              您知道身體有多少穴道嗎?您知道按哪個穴道可以讓身體紓壓嗎?花個時間玩場小遊戲，既能認識穴道又能領取折價券唷!
            </p>
          ...
          >
            <swiper-slide
              ><img src="../assets/images/schoolhead.png" alt=""
            /></swiper-slide>
            <swiper-slide
              ><img src="../assets/images/schoolhand.png" alt=""
            /></swiper-slide>
            <swiper-slide
              ><img src="../assets/images/schoolbody.png" alt=""
            /></swiper-slide>
            <swiper-slide
              ><img src="../assets/images/schoolfoot.png" alt=""
            /></swiper-slide>
          </swiper>
        </div>
        <div class="about_us_pic">
      ...
      <section class="product">
        ...
        <div class="product_content">
          <a href=""
            ><div class="product_oil reveal fade-left">
              <img src="../assets/images/index_oils.jpg" alt="" /></div
          ></a>
          <a href=""
            ><div class="product_tool reveal fade-right">
              <img src="../assets/images/index_tools.jpg" alt="" /></div
          ></a>
        </div>
        ...
        <section class="index_reservation">
          <div class="reservation_intro">
            <div class="title_area">
              ...
              <p>
                按指穴提供四種按摩服務項目，不管是久坐上班族，或是帶個兩小孩的全職媽媽，我們都有適合的按摩項目為您解決各種酸痛!
              </p>
      ...
      <section class="index_review">
        ...
        >
          <swiper-slide class="slide"
            ><img src="../assets/images/unhappyCat.png" alt=""
          /></swiper-slide>
          <swiper-slide class="slide"
            ><img src="../assets/images/astronaut.png" alt=""
          /></swiper-slide>
          <swiper-slide class="slide"
            ><img src="../assets/images/strongCat.png" alt=""
          /></swiper-slide>
          <swiper-slide class="slide"
            ><img src="../assets/images/smellCat.png" alt=""
          /></swiper-slide>
          <swiper-slide class="slide"
            ><img src="../assets/images/shockCat.png" alt=""
          /></swiper-slide>
          <swiper-slide class="slide"
            ><img src="../assets/images/FrisbeeGog.png" alt=""
          /></swiper-slide>
        </swiper>
      </section>
      <section class="latest_news reveal fade-top">
        <!------最新消息------->
        <div class="title_area">
          <div class="sure_title">
        ...
        <div class="news_content">
          ...
          <div class="news">
            <div class="pic">
              <img
                src="../assets/images/advanced_study.png"
                alt=""
                id="NEWS_PIC"
              />
            </div>
